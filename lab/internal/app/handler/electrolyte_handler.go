...
// GetElectrolytes godoc
// @Summary      Get list of electrolytes
// @Description  Returns all electrolytes (public access)
// @Tags         Electrolytes
// @Produce      json
// @Param        search query string false "Search by name"
// @Success      200 {object} map[string]interface{} "data: []Electrolyte"
// @Router       /electrolytes [get]
